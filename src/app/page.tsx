...
function generateSudokuBoard(difficulty: number): Board {
  ...
  return (
    <div className='flex gap-2'>
      {Array.from({ length: 9 }, (_, index) => (
        <div key={index} className=" p-2 cursor-pointer hover:bg-gray-200 duration-400 transition-colors text-xl"
